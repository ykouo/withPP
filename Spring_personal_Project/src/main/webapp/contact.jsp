...
<html lang="en">
  ...
  <head>
    ...
    <mytag:Fabicon/>
 	<!-- 구글맵 API 추가 -->
	<script src="http://maps.google.com/maps/api/js?key=구글맵키&region=kr"></script> <!-- 구글맵키 -->
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">    
	...
	<div class="site-section">
		<div class="container">     
					...
					<input type="hidden" name="to" value="anykouo@gmail.com"/>
              		<div class="form-group row">
                		<div class="col-md-6 mb-4 mb-lg-0">
                  			<input type="email" name="from" id="email" class="form-control" placeholder="답변받을 이메일주소" 
			...
			<div class="form-group row">
				<div class="col-md-12">
					<textarea name="content" class="form-control" id="QAcontent"  
					placeholder="문의내용을 작성하세요" cols="30" rows="10" maxlength="500" style="resize: none;"></textarea>
				</div>
			</div>
			<div class="form-group row">
					...
					<ul class="list-unstyled footer-link">
						<li class="d-block mb-3">
							<span class="d-block text-black">Address:</span>
                  			<span>서울특별시 강남구 테헤란로 146 현익빌딩 3층, 4층 (신한은행건물)</span>
                  		</li>
                		<li class="d-block mb-3">
                			<span class="d-block text-black">Phone:</span>
                			<span>010-with-with</span>
                		</li>
                		<li class="d-block mb-3">
                			<span class="d-block text-black">Email:</span>
                			<span>withPP@withPP.com</span>
                		</li>
              		</ul>
            	</div>
			</div>
